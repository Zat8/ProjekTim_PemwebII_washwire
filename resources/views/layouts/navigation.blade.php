<nav x-data="{ open: false, dark: document.documentElement.classList.contains('dark') }"
                ...
                <div class="hidden md:flex items-center space-x-1">
                    @if (auth()->user()->isPelanggan())
                        ...
                        <a href="{{ route('pelanggan.dashboard') }}"
                           class="flex items-center gap-2 px-3 py-2 rounded-md text-sm font-medium transition-colors {{ request()->routeIs('pelanggan.dashboard') ? 'bg-[#9737e3]/10 text-[#9737e3] dark:bg-[#9737e3]/20' : 'text-zinc-500 hover:bg-zinc-100 hover:text-zinc-900 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-zinc-50' }}">
                        ...
                        <a href="{{ route('pelanggan.tracking') }}"
                           class="flex items-center gap-2 px-3 py-2 rounded-md text-sm font-medium transition-colors {{ request()->routeIs('pelanggan.tracking') ? 'bg-[#9737e3]/10 text-[#9737e3] dark:bg-[#9737e3]/20' : 'text-zinc-500 hover:bg-zinc-100 hover:text-zinc-900 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-zinc-50' }}">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    @else
                        ...
                        <a href="{{ route('staff.dashboard') }}"
                           class="flex items-center gap-2 px-3 py-2 rounded-md text-sm font-medium transition-colors {{ request()->routeIs('staff.dashboard') ? 'bg-[#9737e3]/10 text-[#9737e3] dark:bg-[#9737e3]/20' : 'text-zinc-500 hover:bg-zinc-100 hover:text-zinc-900 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-zinc-50' }}">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v4a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v4a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v4a2 2 0 01-2 2H6a2 2 0 01-2-2v-4zM14 16a2 2 0 012-2h2a2 2 0 012 2v4a2 2 0 01-2 2h-2a2 2 0 01-2-2v-4z" />
                            </svg>
                            Dashboard
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden md:hidden bg-white dark:bg-zinc-950 border-t border-zinc-200 dark:border-zinc-800">
        <div class="pt-2 pb-3 space-y-1 px-3">
            @if (auth()->user()->isPelanggan())
                <x-responsive-nav-link :href="route('pelanggan.dashboard')" :active="request()->routeIs('pelanggan.dashboard')" class="rounded-md text-sm font-medium {{ request()->routeIs('pelanggan.dashboard') ? 'bg-[#9737e3]/10 text-[#9737e3] dark:bg-[#9737e3]/20' : 'text-zinc-500 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:bg-zinc-800' }}">
                    Dashboard
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('pelanggan.tracking')" :active="request()->routeIs('pelanggan.tracking')" class="rounded-md text-sm font-medium {{ request()->routeIs('pelanggan.tracking') ? 'bg-[#9737e3]/10 text-[#9737e3] dark:bg-[#9737e3]/20' : 'text-zinc-500 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:bg-zinc-800' }}">
                    Lacak Cucian
                </x-responsive-nav-link>
            @else
                <x-responsive-nav-link :href="route('staff.dashboard')" :active="request()->routeIs('staff.dashboard')" class="rounded-md text-sm font-medium {{ request()->routeIs('staff.dashboard') ? 'bg-[#9737e3]/10 text-[#9737e3] dark:bg-[#9737e3]/20' : 'text-zinc-500 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:bg-zinc-800' }}">
                    Dashboard
                </x-responsive-nav-link>
